...
/**
 * [消息接收（订阅）服务]
 * 创建时间：2021/5/31 23:27
 *
 * @author hforest-480s
 */
@Slf4j
@Service(value = "slaveReceiverRedisImpl")
...
public class ReceiverSlaveRedisServiceImpl implements MessageListener {

    private final StringRedisTemplate stringRedisTemplate;

    public ReceiverSlaveRedisServiceImpl(StringRedisTemplate stringRedisTemplate) {
