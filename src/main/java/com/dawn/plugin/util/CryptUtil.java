...
public class CryptUtil {
     ...
     * @return String
     */
    public static String encryptDesBase64(String key, String message) {
        return encryptBase64(key, key, message, "DES/CBC/PKCS5Padding", "DES", VarEnmu.UTF8.value());
    }
     ...
     **/
    public static String encryptAesBase64(String key, String message) {
        return encryptBase64(key, key, message, "AES/CBC/PKCS5Padding", "AES", VarEnmu.UTF8.value());
    }
     ...
     * @return java.lang.String
     **/
    public static String encryptSm4Base64(String key, String message) {
        return encryptBase64(key, key, message, "CBC", "SM4", VarEnmu.UTF8.value());
    }
    ...
    public static String decodeBase64ByWorld(String key, String iv, String message, String transformation, String algorithm, String encoding) {
        ...
        try {
            ...
            log.error(LogEnmu.LOG6.value(), "encryptBase64", message, transformation, algorithm, encoding, e.toString());
        }
        return result;
    }
     ...
     * @return java.lang.String
     **/
    public static String encryptBase64(String key, String iv, String message, String transformation, String algorithm, String encoding) {
        return switch (algorithm.concat(".").concat(transformation)) {
            case "SM4.CBC" ->
                /* def CBC */
                encryptBase64BySm4Cbc(key, iv, message, Padding.PKCS5Padding, encoding);
            case "AES.CBC" ->
                /* def CBC */
                encryptBase64ByWorld(key, iv, message, AlgEnmu.AES.transformation(), AlgEnmu.AES.algorithm(), encoding);
            default -> encryptBase64ByWorld(key, iv, message, transformation, algorithm, encoding);
        };
    }
     ...
     * @return java.lang.String
     **/
    public static String encryptBase64BySm4Cbc(String key, String iv, String message, Padding padding, String encoding) {
        String result = VarEnmu.NONE.value();
        try {
            SymmetricCrypto sm4 = new SM4(Mode.CBC, padding, key.getBytes(Charset.forName(encoding)), iv.getBytes(Charset.forName(encoding)));
            byte[] encryptHe = sm4.encrypt(message);
            result = cn.hutool.core.codec.Base64.encode(encryptHe);
        } catch (Exception ex) {
            log.error(LogEnmu.LOG5.value(), "encryptBase64BySm4Cbc.加密失败", message, padding, encoding, ex.toString());
        }
        return result;
    }
     ...
     * @return java.lang.String
     **/
    public static String encryptBase64ByWorld(String key, String iv, String message, String transformation, String algorithm, String encoding) {
        String result = VarEnmu.NONE.value();
        try {
            IvParameterSpec ivSpec = new IvParameterSpec(iv.getBytes(encoding));
            ...
            log.error(LogEnmu.LOG6.value(), "encryptBase64.1", message, transformation, algorithm, encoding, e.toString());
                 ...
                 | BadPaddingException
                 | InvalidAlgorithmParameterException e) {
            log.error(LogEnmu.LOG6.value(), "encryptBase64.2", message, transformation, algorithm, encoding, e.toString());
        }
        return result;
    }
     ...
     * @return String
     */
    public static String encryptBase64BySm2(String content, String publicKey) {
        String result = VarEnmu.NONE.value();
        try {
            SM2 sm2 = new SM2(null, publicKey);
            return sm2.encryptBase64(content, KeyType.PublicKey);
        } catch (Exception ex) {
            log.error(LogEnmu.LOG3.value(), "encryptBase64BySm2.加密失败", content, ex.toString());
        }
        return result;
    }
