...
public class CryptoUtil {
     ...
     * @return String
     */
    public static String encryptoDesBase64(String key, String message) {
        return encryptoBase64(key, key, message, "DES/CBC/PKCS5Padding", "DES", VarEnmu.UTF8.value());
    }
     ...
     **/
    public static String encryptoAesBase64(String key, String message) {
        return encryptoBase64(key, key, message, "AES/CBC/PKCS5Padding", "AES", VarEnmu.UTF8.value());
    }
     ...
     * @return java.lang.String
     **/
    public static String encryptoSm4Base64(String key, String message) {
        return encryptoBase64(key, key, message, "CBC", "SM4", VarEnmu.UTF8.value());
    }
    ...
    public static String decodeBase64(String key, String iv, String message, String transformation, String algorithm, String encoding) {
        return switch (algorithm.concat(".").concat(transformation)) {
            case "SM4.CBC" ->
                /* def CBC */
                decodeBase64BySm4Cbc(key, iv, message, Padding.PKCS5Padding, encoding);
            case "AES.CBC" ->
                /* def CBC */
                decodeBase64ByWorld(key, iv, message, AlgEnmu.AES.transformation(), AlgEnmu.AES.algorithm(), encoding);
            default -> decodeBase64ByWorld(key, iv, message, transformation, algorithm, encoding);
        };
    }
    ...
    public static String decodeBase64ByWorld(String key, String iv, String message, String transformation, String algorithm, String encoding) {
        ...
        try {
            ...
            log.error(LogEnmu.LOG6.value(), "encryptoBase64", message, transformation, algorithm, encoding, e.toString());
        }
        return result;
    }
     ...
     * @return java.lang.String
     **/
    public static String encryptoBase64(String key, String iv, String message, String transformation, String algorithm, String encoding) {
        return switch (algorithm.concat(".").concat(transformation)) {
            case "SM4.CBC" ->
                /* def CBC */
                encryptoBase64BySm4Cbc(key, iv, message, Padding.PKCS5Padding, encoding);
            case "AES.CBC" ->
                /* def CBC */
                encryptoBase64ByWorld(key, iv, message, AlgEnmu.AES.transformation(), AlgEnmu.AES.algorithm(), encoding);
            default -> encryptoBase64ByWorld(key, iv, message, transformation, algorithm, encoding);
        };
    }
     ...
     * @return java.lang.String
     **/
    public static String encryptoBase64BySm4Cbc(String key, String iv, String message, Padding padding, String encoding) {
        String result = VarEnmu.NONE.value();
        try {
            SymmetricCrypto sm4 = new SM4(Mode.CBC, padding, key.getBytes(Charset.forName(encoding)), iv.getBytes(Charset.forName(encoding)));
            byte[] encryptoHe = sm4.encrypt(message);
            result = cn.hutool.core.codec.Base64.encode(encryptoHe);
        } catch (Exception ex) {
            log.error(LogEnmu.LOG5.value(), "encryptoBase64BySm4Cbc.加密失败", message, padding, encoding, ex.toString());
        }
        return result;
    }
     ...
     * @return java.lang.String
     **/
    public static String encryptoBase64ByWorld(String key, String iv, String message, String transformation, String algorithm, String encoding) {
        String result = VarEnmu.NONE.value();
        try {
            IvParameterSpec ivSpec = new IvParameterSpec(iv.getBytes(encoding));
            ...
            log.error(LogEnmu.LOG6.value(), "encryptoBase64.1", message, transformation, algorithm, encoding, e.toString());
                 ...
                 | BadPaddingException
                 | InvalidAlgorithmParameterException e) {
            log.error(LogEnmu.LOG6.value(), "encryptoBase64.2", message, transformation, algorithm, encoding, e.toString());
        }
        return result;
    }
     ...
     * @return String
     */
    public static String encryptoBase64BySm2(String content, String publicKey) {
        String result = VarEnmu.NONE.value();
        try {
            SM2 sm2 = new SM2(null, publicKey);
            return sm2.encryptBase64(content, KeyType.PublicKey);
        } catch (Exception ex) {
            log.error(LogEnmu.LOG3.value(), "encryptoBase64BySm2.加密失败", content, ex.toString());
        }
        return result;
    }
     ...
     * [SM2私钥解密]
     *
     * @param encryptoStr [SM2加密字符串]
     * @param privateKey [SM2私钥]
     * @return String
     */
    public static String decodeBase64BySm2(String encryptoStr, String privateKey) {
        String result = VarEnmu.NONE.value();
        try {
            SM2 sm2 = new SM2(privateKey, null);
            result = sm2.decryptStr(encryptoStr, KeyType.PrivateKey);
        } catch (Exception ex) {
            log.error(LogEnmu.LOG3.value(), "decodeBase64BySm2.解密失败", encryptoStr, ex.toString());
        }
        return result;
    }
     ...
     * @return String
     **/
    public static String encryptoBase64ByRsa(String plainText, String publicKeyBase64) {
        try {
            ...
            log.error(LogEnmu.LOG3.value(), "rsaEncryptoBase64.加密失败", plainText, ex.toString());
     ...
     * @return String
     **/
    public static String decryptoBase64ByRsa(String cipherBase64, String privateKeyBase64) {
        try {
            ...
            byte[] encryptoedData = java.util.Base64.getDecoder().decode(cipherBase64);
            ...
            try (java.io.ByteArrayOutputStream out = new java.io.ByteArrayOutputStream()) {
                for (int offset = VarEnmu.ZERO.ivalue(); offset < encryptoedData.length; offset += maxBlock) {
                    int len = Math.min(maxBlock, encryptoedData.length - offset);
                    byte[] block = cipher.doFinal(encryptoedData, offset, len);
                    out.write(block);
                }
                return out.toString(StandardCharsets.UTF_8);
            }
        } catch (Exception ex) {
            log.error(LogEnmu.LOG3.value(), "rsaDecryptoBase64.解密失败", cipherBase64, ex.toString());
            return VarEnmu.NONE.value();
        }
    }
