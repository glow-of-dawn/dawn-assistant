...
public class SensitiveUtil {
    ...
    public static final String NAME_REGEX = """
        ...
        |羊舌|微生|帅|缑|亢|况|郈|琴|梁丘|左丘|东门|西门|佘|佴|伯|赏|南宫|墨|哈|谯|笪|年|爱|仝|代)[\\u4e00-\\u9fa5]{1,2}(?:[\\u4e00-\\u9fa5]{1,2})*
        """;
    /* 手机号正则规则 */
    ...
    public static String desensitization(String data,
        ...
        while (matcher.find()) {
            matcher.appendReplacement(sb,
                dataDesensitization(matcher.group(), showHeadLength, showTailLength, replaceChar));
        }
    ...
    public static String dataDesensitization(String data, int showHeadLength, int showTailLength, String replaceChar) {
        ...
        return StringUtils.left(data, showHeadLength)
            .concat(StringUtils.leftPad(StringUtils.right(data, showTailLength),
                data.length() - showHeadLength,
                replaceChar));
    }
